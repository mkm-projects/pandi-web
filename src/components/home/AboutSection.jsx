  ...
  return (
    <section className="relative bg-white text-center">
      ...
      <div className="max-w-3xl mx-auto mt-10 px-4 py-4 sm:py-8 md:py-14">
        ...
        <p className="text-gray-700 font-light text-base md:text-xl leading-relaxed mb-6 animate-fadeIn delay-100">
          {t("p1")}
        </p>
        <p className="text-gray-700 font-light text-base md:text-xl leading-relaxed mb-8 animate-fadeIn delay-100">
          {t("p2")}
        </p>
        <Link href="/about">
